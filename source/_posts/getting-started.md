...
title: Comezando
date: 2018-12-25
description: Comezando co módelo inicial de blog de Jigsaw
cover_image: /assets/img/post-cover-image-2.png
featured: true
categories: [configuración]
---

Este é un modelo inicial para crear un fermoso blog personalizable cun esforzo mínimo. Só terás que cambiar algúns axustes e xa está listo.<!-- more -->

## Configuración

Como ocorre con todos os sitios de Jigsaw, as opcións de configuración se atopan en `config.php`; pódense actualizar as variables dese arquivo con axustes específicos para o noso sitio. Tamén se poden engadir aí novas variables de configuración para empregar no novo sitio; bótalle un ollo á [documentación de Jigsaw](http://jigsaw.tighten.co/docs/site-variables/) para obter máis información.
