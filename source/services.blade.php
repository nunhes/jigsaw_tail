---
title: Services
description: A resume of my services and skills
---
...
<div class="flex-auto w-full container max-w-8xl mx-auto px-4 py-8 lg:px-8">
    <!-- <h1>Services</h1>
     <div class="container"><img src="/assets/img/about.png"
    alt="About image"
    class="flex rounded-full h-64 w-64 bg-contain mx-auto md:float-right my-6 md:ml-10"></div> -->
    <section class="py-20 bg-white">
    <div class="container max-w-6xl mx-auto">
    <h5 class="mt-2 text-2xl text-center text-gray-600">Check out our list of awesome features below.</h5>
