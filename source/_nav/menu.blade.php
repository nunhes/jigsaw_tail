<nav class="hidden lg:flex items-center justify-end text-lg">
    ...
    <a title="{{ $page->siteName }} Services" href="/services" class="ml-6 text-gray-700 hover:text-blue-600 {{ $page->isActive('/services') ? 'active text-blue-600' : '' }}">
        Services
    </a>

    <a title="{{ $page->siteName }} Projects" href="/projects" class="ml-6 text-gray-700 hover:text-blue-600 {{ $page->isActive('/projects') ? 'active text-blue-600' : '' }}">
        Projects
    </a>
